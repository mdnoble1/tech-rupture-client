  ...
  return (
    <section className="h-screen flex items-center justify-center">
      <div className="border border-[#13a0fe] rounded-xl">
        ...
        <h2 className="font-semibold text-3xl lg:text-4xl text-center mt-8 uppercase">- Information -</h2>
        <div className="border border-[#13a0fe] mt-4 mb-8 mx-6 md:mx-10"></div>
        <h2 className="font-bold text-xl lg:text-2xl mb-4">Name : {displayName}</h2>
        <p className="font-bold text-xl lg:text-2xl mb-4">Email : {email}</p>
        <p className="font-bold text-xl lg:text-2xl">Status : <span className="text-[#13a0fe]">Verified</span></p>
        </div>
        <div className="text-center">
